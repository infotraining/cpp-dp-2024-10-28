...
namespace {
    bool is_registered = Drawing::SingletonShapeRWFactory::instance().register_creator(Drawing::make_type_index<Drawing::Rectangle>(), [] { return std::make_unique<Drawing::IO::RectangleReaderWriter>(); });
}
